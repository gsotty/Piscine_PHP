								...
								<div class="fiche-produit-prix-stock admin_prix_stock">
									...
									<input type="checkbox" name="choix4" value="4"> biscuit
									 <select class="categorie_produit" name="categorie"> -->
									  <input type="checkbox" name="E-cigarettes" value="E-cigarettes" <?php if(isset($_POST['categorie'])&& $_POST['categorie']=="E-cigarettes") echo "checked";?> />E-cigarettes
									  <input type="checkbox" name="E-liquides" value="E-liquides" <?php if(isset($_POST['categorie'])&& $_POST['categorie']=="E-liquides") echo "checked";?> />E-liquides
									  <input type="checkbox" name="Accessoires" value="Accessoires" <?php if(isset($_POST['categorie'])&& $_POST['categorie']=="Accessoires") echo "checked"; ?>/>Accessoires
									  <br/>
								<br/>
